    ...
    <div class="row justify-content-center">
        <div class="col col-xl-5">
            <div class="content-header mb-5">
                <h3 class="text-center text-color-primary">Login <span class="text-color-secondary">Akun</span>
                </h3>
            </div>
            <div class="mb-30 card">
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="iUsername" class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" name="username" placeholder="Username" autofocus required> 
                    ...
                    <div class="text-center">
                        <p class="mb-0">Belum Memiliki Akun? <a href="{{ url('register') }}">
                                <b>Daftar Sekarang</b>
                            </a>
                        </p>
                    </div>
