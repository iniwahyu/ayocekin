                            ...
                            <div class="col-lg-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format(session()->get('price')) }} (YANG DIBAYARKAN {{ number_format(session()->get('price_new')) }})</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                ...
                                <div class="payment-detail text-center py-3">
                                    ...
                                    <h3 class="mb-0" style="color: red;">{{ number_format(session()->get('price_new')) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
